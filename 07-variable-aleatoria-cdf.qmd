...
|---|---|---|---|
| Cuaderno de Google Colab | Notebook interactivo (R) | [Abrir en Colab](https://colab.research.google.com/github/gilbertorodriguez59/introduccion-probabilidad-r-geogebra/blob/main/notebooks/07-variable-aleatoria-cdf-colab.ipynb) | Experimentar con transformaciones y CDF mediante código ejecutable. |
