...
|---|---|---|---|
| Cuaderno de Google Colab | Notebook interactivo (R) | [Abrir en Colab](https://colab.research.google.com/github/gilbertorodriguez59/introduccion-probabilidad-r-geogebra/blob/main/notebooks/17-transformaciones-variables-colab.ipynb) | Ejecutar transformaciones, convoluciones y simulaciones. |
| Cuaderno de R | R Markdown | [Abrir cuaderno R](https://github.com/gilbertorodriguez59/introduccion-probabilidad-r-geogebra/blob/main/cuadernos-r/17-transformaciones-variables.Rmd) | Reproducir cálculos y gráficas en R/RStudio. |
